  ...
  return (
    <div className="min-h-[calc(100vh-8rem)] bg-gradient-to-b from-slate-50 to-white">
      <div className="mx-auto max-w-6xl space-y-6 px-4 py-8 sm:px-6">
        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-gradient-to-br from-indigo-50 via-white to-amber-50/40 p-6 shadow-sm sm:p-8">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 shadow-sm">
            ...
            <p className="mt-1 text-2xl font-bold text-slate-800">{stats.legacy}</p>
          </div>
        </div>
        ...
        {lines.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-slate-200 bg-white py-16 text-center shadow-sm">
            ...
            <p className="mt-3 text-slate-600">{t("user.myPurchases.empty")}</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
            {lines.map(({ key, order, item }) => {
              ...
              return (
                ...
                >
                  <div className="flex gap-4 border-b border-slate-100 bg-slate-50/80 p-4">
                    <div className="h-20 w-20 shrink-0 overflow-hidden rounded-xl bg-white ring-1 ring-slate-100">
                      {item.image ? (
                        <img
                          src={item.image}
                          alt=""
                  ...
                  <div className="flex flex-1 flex-col gap-3 p-4">
                    ...
                    <button
                      ...
                      className="btn mt-auto gap-2 rounded-xl border-none bg-indigo-600 text-white hover:bg-indigo-700"
                    >
